...
class TestJSONWarningDB(unittest.TestCase):
    ...
    def test_file_not_existant(self):
        ...
        warning = RefWarning(user_id=filename, timestamp=time.time())
    ...
    def test_put_warning_return(self):
        ...
        warning = RefWarning(user_id=user_id, reason=message, timestamp=time.time())
        with JSONWarningRepository(filepath=DB_FILE) as db:
    ...
    def test_delete_warning(self):
        ...
        warning_1 = RefWarning(user_id=user_1, timestamp=time.time())
        warning_1b = RefWarning(user_id=user_1, timestamp=time.time(), reason="stay")
        warning_2 = RefWarning(user_id=user_2, timestamp=time.time())
        warning_3 = RefWarning(user_id=user_3, timestamp=time.time())
